...
import '../models/oylik_daqiqa_models.dart';

// ignore: camel_case_types
class Gap_kop_mobiuz extends StatelessWidget {
  const Gap_kop_mobiuz({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Gap_kop_items(models[index]);
        });
  }
}

// ignore: non_constant_identifier_names
Widget Gap_kop_items(Oylik_models_mobi_daqiqa models) {
  return Padding(
