...
class OperatorUcell extends StatelessWidget {
  const OperatorUcell({super.key});
  static List<models_operator> operator = [
    ...
    models_operator(
        name: "Mobile xizmat bo'yicha",
        info: "Rasmiy aloqa markazi band bo'lganda",
        code: "+998946563333"),
    models_operator(
        name: "Mobile xizmat bo'yicha", info: "Abonentlar uchun", code: "8123"),
    models_operator(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                      child: Text(
                    operator.info,
                    style: TextStyle(color: Color(0xff6b2d82)),
                  ))
                ],
              ),
            ),
            ...
            Text(
              ...
              style: const TextStyle(
                  color: Color.fromARGB(124, 107, 45, 130), fontSize: 16),
            ),
            const SizedBox(
              height: 10,
            )
